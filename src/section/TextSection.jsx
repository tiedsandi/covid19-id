...
const TextSection = () => {
    return (
        <div className='TextSection'>
            ...
            <p className="Text">
                Korona atau COVID-19 adalah penyakit yang disebabkan oleh virus.Penyakit ini dapat menyebabkan gejala-gejala seperti demam, batuk, dan kesulitan bernapas. Penyakit ini dapat menyebabkan kematian jika tidak ditangani dengan cepat. Virus dapat menular dengan mudah ke orang lain. Penularan virus ini dapat menyebabkan infeksi pada sistem kimia mikro yang menjadi kontak dengan kulit.
            </p>
